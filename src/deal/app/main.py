...
# ---------------------------------------------------
st.markdown("<h2 style='color: #2196F3;'>Low Values</h2>", unsafe_allow_html=True)
selected = []
...
# ---------------------------------------------------
st.markdown("<h2 style='color: #F44336; margin-top:1rem;'>High Values</h2>", unsafe_allow_html=True)
...
if not result["valid"]:
    ...
    # ---------------------------------------------
    # -------- HTML row 3 for: Final Offer --------
    # ---------------------------------------------
    st.markdown("<h2 style='color: #00C853;'>Offer Guess based on EV</h2>", unsafe_allow_html=True)
    st.markdown(
        f"""
        <div style="
